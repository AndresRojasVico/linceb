<x-layouts::auth :title="__('Register')">
    <div class="flex flex-col gap-6">
        ...
        <form method="POST" action="{{ route('register.store') }}" class="flex flex-col gap-6">
            ...
            <!-- Company -->
            <flux:input name="company" :label="__('Company')" :value="old('company')" type="text" required autofocus
                autocomplete="Company" :placeholder="__('Company')" />

            <!-- nif -->
            <flux:input name="nif" :label="__('NIF Company')" :value="old('nif')" type="text" required autofocus
                autocomplete="nif" :placeholder="__('NIF')" />
